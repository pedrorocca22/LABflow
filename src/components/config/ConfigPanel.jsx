...
export default function ConfigPanel() {
  ...
  const WellSelector = ({ type, label, slotField, wellsField, wellsValue }) => {
    ...
    return (
      <div className={`p-3 rounded-lg border transition-colors ${isActive ? 'border-primary-400 bg-primary-50' : 'border-surface-200'}`}>
        ...
        <select
          ...
          className="w-full p-2 text-sm border border-surface-300 rounded-md bg-white focus:ring-2 focus:ring-primary-400 focus:border-primary-400 outline-none mb-2"
        >
  ...
  const Input = ({ label, type = 'text', field, value, ...props }) => (
    <div className="mb-3">
      ...
      <input
        ...
        className="w-full p-2 text-sm border border-surface-300 rounded-md bg-white focus:ring-2 focus:ring-primary-400 focus:border-primary-400 outline-none"
        {...props}
      />
    </div>
  );
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="p-4 border-b border-surface-100 shrink-0">
        <h2 className="text-base font-semibold flex items-center gap-2 text-surface-800 capitalize">
          <SlidersHorizontal className="w-5 h-5 text-primary-500" />
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {warning && (
          <div className="mb-4 p-3 bg-warning-50 border-l-4 border-warning-500 text-warning-600 text-sm rounded-r-lg">
        ...
        {activeStep.type === 'comment' && (
          <div className="mb-3">
            ...
            <textarea
              ...
              rows={5}
              className="w-full p-2 text-sm border border-surface-300 rounded-md bg-white focus:ring-2 focus:ring-primary-400 focus:border-primary-400 outline-none resize-none"
            />
          </div>
        )}
        ...
        <div className="mt-6 pt-4 border-t border-surface-200">
          <button
            ...
            className="w-full bg-primary-600 hover:bg-primary-700 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors shadow-sm"
          >
            Guardar
          </button>
        </div>
